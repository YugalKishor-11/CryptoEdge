...
export default function CryptoAISec() {
    return (
        <section className="overflow-hidden rounded-3xl bg-linear-to-r from-blue-500 to-purple-500 p-3 text-white shadow-md">
            <div className="flex flex-col  justify-between gap-5 lg:gap-3 md:flex-row md:items-center">
                <div>
                    ...
                    <p className="mt-3 lg:mt-0 max-w-md text-sm text-white/80">
                    ...
                    <div className="flex lg:mt-0 justify-between items-center pt-2.5 ">
                        <button className=" xl:mt-5 flex  items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-medium text-black hover:bg-slate-100 transition-colors">
